...
- zlicza wystąpienia zdarzenia takiego, że średni poziom PM2.5 zmierzony danego dnia przez konkretną stację pomiarową przekroczył dopuszczalny próg.

- grupuje dane o dniach z przekroczeniem normy po województwach

- wybiera `top_n` (na przykład 3) województwa z największą i z najmniejszą liczbą dni przekraczających poziom zanieczyszczeń

- rysuje wykres *Grouped barplot* analogiczny do zadania 4.

---

*Alternatywną interpretacją tego zadania byłoby policzenie średniego poziomu PM2.5 we wszystkich stacjach danego województwa DANEGO DNIA (czlyli najpierw grupujemy pomiary po województwie, potem po dniu, a po stacji pomiarowej nie grupujemy wcale). Opis części 8. sugeruje jednak pierwszą interpretację* 
...
Koncepcyjnie, różnica działania tych dwóch funkcji jest bardzo duża, jednak brakujących pomiarów nie jest aż tak wiele. Mimo wszystko, końcowy wykres jest odrobinę inny w zależności od tego, którą funkcję się wybierze - 
